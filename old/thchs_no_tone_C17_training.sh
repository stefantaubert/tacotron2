...
python train.py --base_dir=$base_dir --checkpoint_path=$pretrained --warm_start='true' --n_gpus=1 --rank=0 --group_name='group_name' --hparams='sampling_rate=16000,batch_size=35,iters_per_checkpoint=100,epochs=500' --debug='false' --merge_symbols='false'
