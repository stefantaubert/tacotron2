...
python script_txt_pre.py --base_dir=$base_dir --ipa='true' --text='examples/north_ger.txt' --is_ipa='true'
python synthesize.py --base_dir=$base_dir --checkpoint=$checkpoint --output_name='north_ger'
