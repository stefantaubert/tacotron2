...
class UnitTests(unittest.TestCase):
  ...
  def test_detect_silence_float32_buffer_smaller_trim(self):
    ...
    buffer_size = 10
    result = detect_leading_silence(audio, silence_threshold=-50.0, chunk_size=1, buffer=buffer_size)
  ...
  def test_detect_silence_float32_buffer_equals_trim(self):
    ...
    result = detect_leading_silence(audio, silence_threshold=-50.0, chunk_size=1, buffer=pause_samples)
  ...
  def test_detect_silence_float32_buffer_greater_trim(self):
    ...
    result = detect_leading_silence(audio, silence_threshold=-50.0, chunk_size=1, buffer=pause_samples + 1)
  ...
  def test_remove_start_and_end_silence_float32(self):
    ...
    result = remove_silence(audio, threshold_start=-50.0, threshold_end=-50.0, chunk_size=1, buffer_start=0, buffer_end=0)
