...
python -m src.cli.runner create-weights-map \
  ...
  --existing_map="maps/weights/thchs_ipa_acc_ljs_ipa.json"

# Training
export hparams="batch_size=$batch_size,iters_per_checkpoint=0,epochs_per_checkpoint=$epochs_per_checkpoint"
