...
# Training
export hparams="batch_size=$batch_size,iters_per_checkpoint=12,epochs=16,ignore_layers=[embedding.weight,speakers_embedding.weight]"
...
## Continue training
export hparams="batch_size=$batch_size,iters_per_checkpoint=12,epochs=16"
python ./src/tacotron/script_train.py \
  --base_dir=$base_dir \
  --training_dir=$custom_training_name \
  --hparams=$hparams \
