...
python -m src.cli.runner waveglow-train \
  ...
  --custom_hparams="batch_size=$batch_size,iters_per_checkpoint=0,epochs_per_checkpoint=$epochs_per_checkpoint,epochs=100000"
...
python -m src.cli.runner waveglow-validate --train_name="pretrained_v3_ljs" --entry_id=10017 --denoiser_strength=0.00 --sigma=0.777
python -m src.cli.runner waveglow-validate --train_name="pretrained_v3_ljs" --entry_id=10017 --denoiser_strength=0.00 --sigma=1.0
