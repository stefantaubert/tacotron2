...
python paths.py \
  ...
  --custom_training_name"ljs_ipa_warm_mapped" \
  --no_debugging
python script_train.py \
  --base_dir="/home/stefan_taubert/taco2pt_v2" \
  --training_dir="ljs_ipa_warm_mapped" \
  --speakers="ljs_ipa,1" \
  --hparams="batch_size=52,iters_per_checkpoint=100,epochs=500,ignore_layers=[embedding.weight,speakers_embedding.weight]" \
  --pretrained_model="/home/stefan_taubert/taco2pt_v2/thchs_ipa_warm_mapped/checkpoints/6000" \
  --pretrained_model_symbols="/home/stefan_taubert/taco2pt_v2/thchs_ipa_warm_mapped/filelist/symbols.json" \
  --weight_map_mode='use_map' \
  --map="maps/weights/en_chn_v1.json" \
  --warm_start \
  --pretrained_path="/home/stefan_taubert/taco2pt_v2/thchs_ipa_warm_mapped/checkpoints/6000" \
  --no_debugging
...
export model_symbols="/home/stefan_taubert/taco2pt_v2/ljs_ipa_warm_mapped/filelist/symbols.json"
